...
\begin{minipage}{\linewidth}
\lstinputlisting[frame=single, caption={Functional implementation of findCommonWords with declared operators}, label={lst:functional-declared}, language=js]{code/sample-functional-declared.js}
\end{minipage}
