...
In addition to shadowing, as with many other languages, property accesses \inlinecode{a.b} may actually be backed by a function invocation \cite{getter16}.  When retrieving \inlinecode{b} from the object \inlinecode{a} a function may be invoked that could modify closed variables or alter global state.  