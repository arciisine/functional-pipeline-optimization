\section{High Level}
The algorithm attempts to mimic the assumptions and behavior of programmers when converting functional pipeline stages (\inlinecode{map}, \inlinecode{reduce}, \inlinecode{filter}, etc.) into \inlinecode{for} loop semantics.
