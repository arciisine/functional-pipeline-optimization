...
In the code listing, each chain operation is invoked as a member of the chain target (with the appropriate input), and that is stored as the new chain target.  This is functionally equivalent, and generally performs as well as the original form. %Needs proof/verification
