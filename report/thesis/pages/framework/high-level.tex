\section{High Level}
The analysis framework attempts to mimic the assumptions and behavior of programmers when converting \pipelineoperators (\inlinecode{map}, \inlinecode{reduce}, \inlinecode{filter}, etc.) into \inlinecode{for} loop semantics. 
