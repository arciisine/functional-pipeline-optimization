...
import {TransformResponse, TransformReference, TransformState, Transformer, Util} from '../collector/util';

class ArrayTransformers {
  static filter(ref:TransformReference, state:TransformState):TransformResponse {
    ...
    return Util.standardHandler(ref);
  }
...
export const Transformers:{[type:string]:Transformer} = ArrayTransformers as any;